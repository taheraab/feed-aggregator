...
BEGIN
CREATE TABLE IF NOT EXISTS User (id SMALLINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100), password CHAR(61), emailId VARCHAR(100) NOT NULL, token VARCHAR(33), tokenTimestamp INT UNSIGNED, confirmed ENUM ('no', 'yes') NOT NULL);
