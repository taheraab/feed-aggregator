...
BEGIN
CREATE TABLE IF NOT EXISTS User (id SMALLINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100), username VARCHAR(50) UNIQUE NOT NULL, password CHAR(61));
...
CREATE TABLE IF NOT EXISTS UserFeedRel (user_id SMALLINT UNSIGNED, feed_id SMALLINT UNSIGNED, folder_id SMALLINT UNSIGNED, PRIMARY KEY (user_id, feed_id), FOREIGN KEY (user_id) REFERENCES User (id) ON DELETE CASCADE, FOREIGN KEY (feed_id) REFERENCES Feed (id) ON DELETE CASCADE, FOREIGN KEY (folder_id) REFERENCES Folder (id) ON DELETE SET NULL);
...
CREATE TABLE IF NOT EXISTS Folder (id SMALLINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100) NOT NULL, user_id SMALLINT UNSIGNED, FOREIGN KEY (user_id) REFERENCES User (id) ON DELETE CASCADE);
END
EOP;
