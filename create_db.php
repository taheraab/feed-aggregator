...
BEGIN
CREATE TABLE IF NOT EXISTS User (id SMALLINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(100), username VARCHAR(50) UNIQUE NOT NULL, password CHAR(61), emailId VARCHAR(100) NOT NULL);
